...
План развития: заменить in-memory-хранилище PostgreSQL-репозиторием, добавить безопасное хэширование паролей, refresh-токены, API keys для headless-клиентов и аудит действий.
